...
struct ContentView: View {
    ...
    var body: some View {
        VStack {
            ColorCyclingRectangle(amount: colorRectangle, gradientStartX: gradientStartX,gradientStartY: gradientStartY, gradientEndX: gradientEndY, gradientEndY: gradientEndY)
